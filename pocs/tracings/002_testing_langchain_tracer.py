"""POC 002 — Testing the LangChain tracer with a real Azure OpenAI agent."""
...
def main() -> None:
    ...
    print("=" * 80)
    print("Running agent with query: 'What is the weather in Berlin and Tokyo?'")
    print("Also: 'Calculate 42 * 17'")
    print("=" * 80)
    ...
    print("\n✅ LangChain tracer POC completed!")
